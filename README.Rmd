...
[![R-CMD-check](https://github.com/INWT/mpi-iso-app-data/workflows/R-CMD-check/badge.svg)](https://github.com/INWT/mpi-iso-app-data/actions)
...
This R package to retrieve data from Max-Planck-Institute (MPI) IsoMemo Web-application API and publish on CRAN for public download. For more information, please visit: <https://isomemo.com/>
...
You can install the released version of IsomemoData from [CRAN](https://CRAN.R-project.org) with:
